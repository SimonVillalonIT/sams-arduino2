    ...
    <>
      <section
        ...
        style={{
          ...
          backgroundImage:
            "linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),url(hero-image.jpg)",
      ...
      >
        ...
        <div className="text-center text-white">
          <div className="max-w-md">
            {" "}
            <h1 className="mb-5 text-5xl font-extrabold">SAMS</h1>
            <p className="bold mb-5">
              Tu solucion a las aulas con ruidos molestos
            </p>
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            Esta moderna aplicación cuenta con nuevas características que
            mejoraran su experiencia como guardado de datos, monitoreo en tiempo
            real, etc.
          </p>
        </div>
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
          ...
          <Feature
            height={50}
            width={150}
            alt="caracteristica tiempo real"
            src="/realtime.svg"
          />
